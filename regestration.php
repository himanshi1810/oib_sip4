...
if(isset($_POST['submit'])) {
    ...
    if ($emailCount > 0) {
        ...
        if($password === $cpassword){
            ...
            $insertQuery = "insert into regestration(name, email, mobile, password, cpassword) values('$username','$email','$mobile','$pass','$cpass') ";
            ...
            if($iquery) {
                ...
                ?>
                    <script>
                        alert("Error Occurs in Insertion");
                    </script>
                <?php
            }
              ...
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="text" id="mobile" class="form-control" required name="mobile"/>
                      <label class="form-label" for="mobile" >Your PhoneNumber</label>
                    </div>
                  </div>
